...
public:
	...
	/// setMeanReferenceState() updates the mean reference state for the final
	/// deterministic reference/tuning pass. The default implementation is a
	/// no-op for beam types that do not override it.
